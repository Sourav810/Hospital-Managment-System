...
<!-- This code is to check is the database successfully connected and print a msg on index page -->
<%--  <% 
...
<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="true">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/hosp1.jpg" class="d-block w-100" alt="..." height="650px">
    </div>
    <div class="carousel-item">
      <img src="img/hosp2.jpg" class="d-block w-100" alt="..." height="650px">
    </div>
    <div class="carousel-item">
      <img src="img/hosp3.jpg" class="d-block w-100" alt="..." height="650px">
    </div>
  </div>
